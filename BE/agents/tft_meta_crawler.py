...
# ================================================================
BASE_ITEMS = {
    "TFT_Item_BFSword": "Kiếm B.F.",
    "TFT_Item_RecurveBow": "Cung Gỗ",
    "TFT_Item_NeedlesslyLargeRod": "Gậy Quá Khổ",
    "TFT_Item_TearOfTheGoddess": "Nước Mắt Nữ Thần",
    "TFT_Item_ChainVest": "Giáp Lưới",
    "TFT_Item_NegatronCloak": "Áo Choàng Bạc",
    "TFT_Item_GiantsBelt": "Đai Khổng Lồ",
    "TFT_Item_SparringGloves": "Găng Đấu Tập",
...
ITEM_IMAGE_MAP = {
    # Base items
    "Kiếm B.F.": "item_bf_sword",
    "Cung Gỗ": "item_recurve_bow",
    "Gậy Quá Khổ": "item_needlessly_large_rod",
    "Nước Mắt Nữ Thần": "item_tear_of_the_goddess",
    "Giáp Lưới": "item_chain_vest",
    "Áo Choàng Bạc": "item_negatron_cloak",
    "Đai Khổng Lồ": "item_giants_belt",
    "Găng Đấu Tập": "item_sparring_gloves",
...
ITEM_RECIPES = {
    # BF Sword combos
    "Kiếm Tử Thần": ("Kiếm B.F.", "Kiếm B.F."),
    "Diệt Khổng Lồ": ("Kiếm B.F.", "Cung Gỗ"),
    "Kiếm Súng Hextech": ("Kiếm B.F.", "Gậy Quá Khổ"),
    "Ngọn Giáo Shojin": ("Kiếm B.F.", "Nước Mắt Nữ Thần"),
    "Áo Choàng Bóng Tối": ("Kiếm B.F.", "Giáp Lưới"),
    "Huyết Kiếm": ("Kiếm B.F.", "Áo Choàng Bạc"),
    "Móng Vuốt Sterak": ("Kiếm B.F.", "Đai Khổng Lồ"),
    "Vô Cực Kiếm": ("Kiếm B.F.", "Găng Đấu Tập"),
    # Recurve Bow combos
    "Bùa Đỏ": ("Cung Gỗ", "Cung Gỗ"),
    "Cuồng Đao Guinsoo": ("Cung Gỗ", "Gậy Quá Khổ"),
    "Trượng Hư Vô": ("Cung Gỗ", "Nước Mắt Nữ Thần"),
    "Quyền Năng Khổng Lồ": ("Cung Gỗ", "Giáp Lưới"),
    "Thịnh Nộ Thủy Quái": ("Cung Gỗ", "Áo Choàng Bạc"),
    "Nanh Nashor": ("Cung Gỗ", "Đai Khổng Lồ"),
    "Cung Xanh": ("Cung Gỗ", "Găng Đấu Tập"),
    # Needlessly Large Rod combos
    "Mũ Phù Thủy Rabadon": ("Gậy Quá Khổ", "Gậy Quá Khổ"),
    "Quyền Trượng Thiên Thần": ("Gậy Quá Khổ", "Nước Mắt Nữ Thần"),
    "Vương Miện Hoàng Gia": ("Gậy Quá Khổ", "Giáp Lưới"),
    "Nỏ Sét": ("Gậy Quá Khổ", "Áo Choàng Bạc"),
    "Quỷ Thư Morello": ("Gậy Quá Khổ", "Đai Khổng Lồ"),
    "Găng Bảo Thạch": ("Gậy Quá Khổ", "Găng Đấu Tập"),
    # Tear of the Goddess combos
    "Bùa Xanh": ("Nước Mắt Nữ Thần", "Nước Mắt Nữ Thần"),
    "Lời Thề Hộ Vệ": ("Nước Mắt Nữ Thần", "Giáp Lưới"),
    "Mũ Thích Nghi": ("Nước Mắt Nữ Thần", "Áo Choàng Bạc"),
    ...
    "Trái Tim Kiên Định": ("Giáp Lưới", "Găng Đấu Tập"),
    # Negatron Cloak combos
    "Vuốt Rồng": ("Áo Choàng Bạc", "Áo Choàng Bạc"),
    "Giáp Vai Nguyệt Thần": ("Áo Choàng Bạc", "Đai Khổng Lồ"),
    "Áo Choàng Thủy Ngân": ("Áo Choàng Bạc", "Găng Đấu Tập"),
    # Giant's Belt combos
    "Giáp Máu Warmog": ("Đai Khổng Lồ", "Đai Khổng Lồ"),
    "Chùy Đoản Côn": ("Đai Khổng Lồ", "Găng Đấu Tập"),
    # Sparring Gloves combo
    "Găng Đạo Tặc": ("Găng Đấu Tập", "Găng Đấu Tập"),
    # Spatula combo
