    ...
    def enhance_query(self,
        ...
        if len(current_query) <= max_context_rewrite_length:
            ...
            3. Generate an improved, standalone search query that:
               ...
               - Do not translate the query. You must keep the query in the same language as the question.
            ...
            If the current query is already concise or irrelevant with respect to the conversation history, you can return it as is. You must keep the query in the same language as the question.
            ...
            6. Do not translate the query. You must keep the query in the same language as the question.
        
                IMPORTANT: Output ONLY the improved and summarized query. No explanations, prefixes, or formatting. You must keep the query in the same language as the question.
